...
export const RAW_EXERCISES: readonly RawExercise[] = [
  {
    ...
    aliases: ['Barbell Bench Press', 'Flat Bench Press (Barbell)'],
  ...
  },
  {
    ...
    aliases: ['Barbell Incline Bench Press', 'Incline Press (Barbell)'],
    equipmentType: 'barbell',
    laterality: 'bilateral',
    loadSemantics: 'external',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Narrow Grip Bench Press (Barbell)'],
    equipmentType: 'barbell',
    laterality: 'bilateral',
    loadSemantics: 'external',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Seated Chest Press (Machine)', 'Machine Chest Press'],
  ...
  },
  {
    ...
    aliases: ['Seated Chest Fly (Cable)', 'Cable Chest Fly', 'Cable Crossover'],
    equipmentType: 'cable',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'per_side',
  ...
  },
  {
    ...
    aliases: ['Machine Chest Fly', 'Butterfly (Machine)'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    movementId: 'horizontal_press',
    name: 'Dip',
    aliases: ['Chest Dip', 'Parallel Bar Dip', 'Triceps Dip'],
    equipmentType: 'bodyweight',
    laterality: 'bilateral',
  ...
  },
  {
    ...
    aliases: ['Shoulder Press (Barbell)', 'Military Press (Barbell)', 'Standing Overhead Press'],
    equipmentType: 'barbell',
    laterality: 'bilateral',
    loadSemantics: 'external',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Shoulder Press (Machine)', 'Machine Shoulder Press'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Dumbbell Lateral Raise', 'Side Lateral Raise (Dumbbell)'],
    equipmentType: 'dumbbell',
    laterality: 'bilateral',
    loadSemantics: 'external',
    loadEntryMode: 'per_hand',
  ...
  },
  {
    ...
    aliases: ['Reverse Pec Deck', 'Reverse Fly (Machine)'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Assisted Pull-Up', 'Machine Assisted Pull Up'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
  ...
  },
  {
    ...
    aliases: ['Narrow Grip Lat Pulldown', 'Close Grip Pulldown'],
    equipmentType: 'cable',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Incline Bench Row (Dumbbell)'],
    equipmentType: 'dumbbell',
    laterality: 'bilateral',
    loadSemantics: 'external',
    loadEntryMode: 'per_hand',
  ...
  },
  {
    ...
    aliases: ['Machine Seated Row', 'Machine Row'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Leg Press', '45 Degree Leg Press'],
    equipmentType: 'machine_plate_loaded',
    laterality: 'bilateral',
    loadSemantics: 'external',
    loadEntryMode: 'per_side',
  ...
  },
  {
    ...
    aliases: ['Leg Extension', 'Knee Extension (Machine)'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Standing Calf Raise (Machine)', 'Calf Raise (Machine)'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Incline Dumbbell Curl', 'Incline Bicep Curl (Dumbbell)'],
    equipmentType: 'dumbbell',
    laterality: 'bilateral',
    loadSemantics: 'external',
    loadEntryMode: 'per_hand',
  ...
  },
  {
    ...
    aliases: ['Dumbbell Overhead Triceps Extension', 'Seated Triceps Extension (Dumbbell)'],
    equipmentType: 'dumbbell',
    laterality: 'bilateral',
    loadSemantics: 'external',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Machine Triceps Extension', 'Cable Triceps Extension (Machine)'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Machine Crunch', 'Abdominal Crunch (Machine)'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Adductor Machine', 'Seated Hip Adduction'],
    equipmentType: 'machine_stack',
    laterality: 'bilateral',
    loadSemantics: 'machine_stack',
    loadEntryMode: 'total',
  ...
  },
  {
    ...
    aliases: ['Dumbbell Wrist Curl', 'Seated Wrist Curl'],
    equipmentType: 'dumbbell',
    laterality: 'unilateral_isolated',
    loadSemantics: 'external',
    loadEntryMode: 'per_hand',
